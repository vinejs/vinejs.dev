...
const messages = {
  ...
  regex: 'The {{ field }} field format is valid',
  ...
  minLength: 'The {{ field }} field must have at least {{ value }} characters',
  maxLength: 'The {{ field }} field must not be greater than {{ value }} characters',
  fixedLength: 'The {{ field }} field must be {{ value }} characters long',
